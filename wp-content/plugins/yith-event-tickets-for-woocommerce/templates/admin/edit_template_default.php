<div class="yith_wcevti_mail_template_default">
    ...
    <?php if (defined('YITH_YWBC_PREMIUM')) {?>
        ...
        <p class="form-field">
           <a href="https://yithemes.com/themes/plugins/yith-woocommerce-barcodes-and-qr-codes/"> <?php echo __('If you want to display barcodes
           on your Event Tickets, please, install YITH WooCommerce Barcodes and Qr Codes plugin', 'yith-event-tickets-for-woocommerce'); ?></a>
        </p>
        <?php
    }?>
