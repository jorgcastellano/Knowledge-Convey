    ...
    class YITH_WC_Min_Max_Qty {
        ...
        public function ywmmq_cart_validation() {
            ...
            if ( $on_cart_page || $on_checkout_page ) {
                ...
                if ( $woocommerce->cart->cart_contents ) {
                    ...
                    $is_premium = defined( 'YWMMQ_PREMIUM' );
                    ...
                    if ( $errors ) {
                        ...
                        if ( function_exists( 'wc_add_notice' ) ) {
                            ...
                            $woocommerce->add_error( $error_list );
        ...
        public function ywmmq_check_validation_cart( $data, $on_cart_page, &$errors ) {
            ...
            if ( !$data['is_valid'] ) {
                ...
                if ( $on_cart_page ) {
                    ...
                    wp_safe_redirect( $woocommerce->cart->get_cart_url(), 302 );
                    exit;
        ...
        public function ywmmq_cart_total_qty() {
            ...
            foreach ( $woocommerce->cart->cart_contents as $item_id => $item ) {
                ...
                if ( defined( 'YWMMQ_PREMIUM' ) && $this->ywmmq_check_exclusion( $item_id, $item['product_id'] ) ) {
                    continue;
                }
