<tr class="yith_evti_increase_by yith_evti_stock_row">
    <td class="drag-icon">
    ...
    <td colspan="4">
        <div class="option-threshold">
            <input type="number" class="yith-wceti-stock-treshold"
                   name="_increase_by_stock[<?php echo $index ?>][_threshold]"
                   id="_increase_by_stock_<?php echo $index ?>_threshold"
                   value="<?php echo isset( $increase['_threshold'] ) ? $increase['_threshold'] : '' ?>">
        </div>

        <div class="option-increase-type">
            <select id="_increase_by_stock_<?php echo $index ?>_increase_ticket_event_type"
                    name="_increase_by_stock[<?php echo $index ?>][_increase_ticket_event_type]"
        ...
        <div class="option-increase-value">
            <div class="yith-wceti-increase-fixed">
                <input type="text" class="wc_input_price"
                       name="_increase_by_stock[<?php echo $index ?>][_increase_fixed_amount]"
                       id="_increase_by_stock_<?php echo $index ?>_increase_fixed_amount"
            ...
            <div class="yith-wceti-increase-percentage">
                <input type="number"
                       name="_increase_by_stock[<?php echo $index ?>][_increase_percentage_amount]"
                       id="_increase_by_stock_<?php echo $index ?>_increase_percentage_amount"
        ...
        <div class="option-description">
            <label for="_increase_by_stock_<?php echo $index ?>_increase_description"><?php echo __( 'Description', 'yith-event-tickets-for-woocommerce' ); ?></label>
            <textarea class="yith-wceti-increase-description"
                      name="_increase_by_stock[<?php echo $index ?>][_increase_description]"
                      id="_increase_by_stock_<?php echo $index ?>_increase_description"><?php echo isset( $increase['_increase_description'] ) ? $increase['_increase_description'] : '' ?></textarea>
        </div>
    </td>
</tr>
